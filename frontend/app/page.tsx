...
export default function HomePage() {
  ...
  const handleAiSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch('http://localhost:8000/ai/generate-site', {
        method: 'POST',
      ...
      const hostedUrl = data?.data?.url || data?.url || data?.siteUrl
      setGeneratedUrl(hostedUrl || null)

      setAiInput('')
    } catch (error) {
      console.error('Error sending to AI:', error)
      alert('⚠️ Error generating website')
    } finally {
      setIsSubmitting(false)
    }
  }
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-primary-500 to-secondary-600 text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-bold mb-6">
              Welcome to <span className="text-yellow-300">Dracarys</span>
            </h1>
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
              Experience the future of AI-powered web applications with our cutting-edge platform.
            </p>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Connect with AI</h2>
            <p className="text-xl text-gray-600">
              Enter your input below and let our AI agent process your request
            </p>
          </motion.div>
          ...
          >
            ...
            {/* 🔹 Inline website link after generation */}
            {generatedUrl && (
              <div className="mt-6 p-4 border rounded-lg bg-green-50 text-center">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Choose Dracarys?</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our platform combines cutting-edge technology with user-friendly design to deliver exceptional
              experiences.
            </p>
          </motion.div>
